...
@Component({
    selector: 'app-apexchart-range-area',
    imports: [PageTitleComponent, DomixChartsComponent],
    templateUrl: './apexchart-range-area.component.html',
    styleUrl: './apexchart-range-area.component.scss'
})
export class ApexchartRangeAreaComponent {
  rangeBasicChart!: ChartInfo
  rangeChart!: ChartInfo
