...
@Component({
    selector: 'app-apextree-collapse-expand',
    imports: [PageTitleComponent],
    templateUrl: './apextree-collapse-expand.component.html',
    styleUrl: './apextree-collapse-expand.component.scss'
})
export class ApextreeCollapseExpandComponent {
  ...
  ngOnInit(): void {
    this.colorCodes = this.colorService.getColorCodes(['bg-gray-200', 'bg-gray-500', 'bg-white', 'bg-primary-100', 'bg-purple-100', 'bg-yellow-100', 'bg-gray-100', 'bg-orange-100', 'bg-green-100', 'bg-pink-100', 'bg-indigo-100']);
