...
@Component({
    selector: 'app-apextree-left-right',
    imports: [PageTitleComponent],
    templateUrl: './apextree-left-right.component.html',
    styleUrl: './apextree-left-right.component.scss'
})
export class ApextreeLeftRightComponent {
