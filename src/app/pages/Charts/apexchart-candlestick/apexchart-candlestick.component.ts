...
@Component({
    selector: 'app-apexchart-candlestick',
    imports: [PageTitleComponent, DomixChartsComponent],
    templateUrl: './apexchart-candlestick.component.html',
    styleUrl: './apexchart-candlestick.component.scss'
})
export class ApexchartCandlestickComponent {

  candlestickChart!: ChartInfo
  ...
  renderChart(): void {
    this.candlestickChart = {
      ...
      chartOptions: {
        ...
        colors: [], // Will be set by the service
        yaxis: {
          tooltip: {
            enabled: true,
          },
        ...
        dataSet: ['bg-green-500', 'bg-red-500'], // Assuming a single dataset for coloring
      },
    };
    ...
    this.basicChart = {
      ...
      chartOptions: {
        ...
        dataSet: ['bg-blue-500', 'bg-green-500'],
        xaxis: {
          type: 'datetime',
        },
      },
