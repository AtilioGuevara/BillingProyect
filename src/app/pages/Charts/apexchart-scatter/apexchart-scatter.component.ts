...
@Component({
    selector: 'app-apexchart-scatter',
    imports: [PageTitleComponent, DomixChartsComponent],
    templateUrl: './apexchart-scatter.component.html',
    styleUrl: './apexchart-scatter.component.scss'
})
export class ApexchartScatterComponent {
  scatterChart!: ChartInfo
  datetimeScatterChart!: ChartInfo
  imagesScatterChart!: ChartInfo
  ...
  renderChart(): void {
    this.scatterChart = {
      ...
      chartOptions: {
        ...
        colors: [], // This will be dynamically set based on the dataset
    ...
    this.datetimeScatterChart = {
      ...
      chartOptions: {
        ...
        colors: [], // Colors will be dynamically populated by the service
        grid: {
          xaxis: {
            lines: {
              show: true,
  ...
  generateDayWiseTimeSeries(
    ...
    for (let i = 0; i < count; i++) {
      ...
      baseval += 86400000; // Increase date by 1 day in milliseconds
    }
    return series;
  }
}
