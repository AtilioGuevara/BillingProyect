...
@Component({
    selector: 'app-table-datatables-enable-disable',
    imports: [
        PageTitleComponent,
        FormsModule,
        CommonModule,
    ],
    templateUrl: './table-datatables-enable-disable.component.html',
    styleUrl: './table-datatables-enable-disable.component.scss'
})
export class TableDatatablesEnableDisableComponent extends DomixGridTestComponent {
